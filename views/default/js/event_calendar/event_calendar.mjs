...
function handleRepeatingSelect(e) {
	$(this).removeClass('event-calendar-repeating-unselected');
	$(this).addClass('event-calendar-repeating-selected');
	var id = $(this).attr('id');
	$("[name='"+id+"-value']").val(1);
...
function handleRepeatingUnselect(e) {
...
function handlePagedPersonalCalendarToggle() {
...
function togglePagedPersonalCalendar(guid) {
 ...
 */
function toggleDisplayPagePersonalCalendar() {
