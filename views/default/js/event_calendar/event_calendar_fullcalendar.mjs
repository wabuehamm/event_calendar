import 'elgg';
import $ from 'jquery';
import 'js/event_calendar/fullcalendar';
...
function init() {
	...
	var loadFullCalendar = function() {
		var locale = $.datepicker.regional[elgg.elgg_get_current_language()];
	...
	if (elgg.elgg_get_current_language() != 'en') {
		deps.push('jquery-ui/i18n/datepicker-'+ elgg.elgg_get_current_language() + '.min');
	}
